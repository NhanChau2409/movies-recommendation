...
export class UsersCrudResolver {
  ...
  async aggregateUsers(
    ...
    @TypeGraphQL.Args() args: AggregateUsersArgs,
  ): Promise<AggregateUsers> {
  ...
  async createManyUsers(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyUsersArgs,
  ...
  async createOneUsers(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateOneUsersArgs,
  ): Promise<Users> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteManyUsers(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteManyUsersArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async deleteOneUsers(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteOneUsersArgs,
  ): Promise<Users | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstUsers(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstUsersArgs,
  ): Promise<Users | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findFirstUsersOrThrow(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstUsersOrThrowArgs,
  ): Promise<Users | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findManyUsers(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindManyUsersArgs,
  ): Promise<Users[]> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findUniqueUsers(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniqueUsersArgs,
  ): Promise<Users | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async findUniqueUsersOrThrow(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindUniqueUsersOrThrowArgs,
  ): Promise<Users | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async groupByUsers(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: GroupByUsersArgs,
  ): Promise<UsersGroupBy[]> {
  ...
  async updateManyUsers(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateManyUsersArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async updateOneUsers(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateOneUsersArgs,
  ): Promise<Users | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async upsertOneUsers(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertOneUsersArgs,
  ): Promise<Users> {
    const { _count } = transformInfoIntoPrismaArgs(info);
